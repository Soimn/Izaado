...
internal void
Targa_ConvertImageToUncompressedTrueColor(String file_contents, u8* destination, umm destination_size)
{
    NOT_IMPLEMENTED;
}

internal void
Targa_ConvertImageToUncompressedGrayscale(String file_contents, u8* destination, umm destination_size)
{
    NOT_IMPLEMENTED;
}